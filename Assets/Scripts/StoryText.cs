...
public class StoryText
{
    ...
    public static string Story1 = "First, there was nothing.\n\n" +
        ...
        "That Tom Fulp guy is just a lackey who carries out Strawberry Clock's will.";
    public static string Story2 = "The first legendary submission by Strawberry Clock was named 'A'.\n\n" +
        "It was glorious.\n\n" +
        "Click it. NOW!";
    ...
    public static string Story5 = "This time, the users listened. The legendary 'B' was saved.\n\n" +
        ...
        "Among these users were a group of clocks that formed the Clock Crew, a gathering of God-Kings sss...";
    public static string Story6 = "Yes. It is I, the legendary Strawberry Clock!\n\n" +
        "It 'B' StrawberryClock himself! The King of the Portal, God of Newgrounds, and leader of the Clock Crew!\n\n" +
    ...
    public static string Story8 = "Yes. It is I, the distinguished Orange Clock.\n\n" +
    ...
    public static string Story15 = "What are you still doing here? Are you really still playing this game?\n\n" + 
